...
import ariel.hardware.ArielHardwareManager;

import android.graphics.Bitmap;

public class QrProvisionActivity extends BaseSetupWizardActivity {

    public static final String TAG = QrProvisionActivity.class.getSimpleName();
    ...
    protected int getLayoutResId() {
        return R.layout.setup_qr_provision;
    }

    @Override
    protected int getTitleResId() {
        return R.string.setup_qr_provision;
    }
    ...
    private void generateAndDisplayQRCode() {
        new QRCodeGenerator().execute(ArielHardwareManager.getInstance(this).getUniquePseudoDeviceId());
    }
